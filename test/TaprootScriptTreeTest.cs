...
namespace Cfd.xTests
{
  public class TaprootScriptTreeTest
  {
    ...
    [Fact]
    public void EmptyTaprootTest()
    {
      var tree = new TaprootScriptTree();
      var internalPubkey = new SchnorrPubkey("1777701648fa4dd93c74edd9d58cfcc7bdc2fa30a2f6fa908b6fd70c92833cfb");
      var internalPrivkey = new Privkey("305e293b010d29bf3c888b617763a438fee9054c8cab66eb12ad078f819d9f27");
      tree.SetInternalPubkey(internalPubkey);
      var data = tree.GetTaprootData();
      Assert.Equal("cc3b1538e0c8144375f71e848b12d609d743992fddfc60dd6ca9b33b8392f27a", data.Pubkey.ToHexString());
      Assert.Equal("", data.TapScript.ToHexString());
      var key = tree.GetTweakedPrivkey(internalPrivkey);
      Assert.Equal("3a56ec9129732312a78db4b845138a3180c102621d7381ae6e6a5d530f14856a", key.ToHexString());
    }

    [Fact]
    public void EmptyTaprootTest2()
    {
      var tapBranch = new TapBranch();
      var internalPubkey = new SchnorrPubkey("1777701648fa4dd93c74edd9d58cfcc7bdc2fa30a2f6fa908b6fd70c92833cfb");
      var internalPrivkey = new Privkey("305e293b010d29bf3c888b617763a438fee9054c8cab66eb12ad078f819d9f27");
      var data = tapBranch.GetTaprootData(internalPubkey);
      Assert.Equal("cc3b1538e0c8144375f71e848b12d609d743992fddfc60dd6ca9b33b8392f27a", data.Pubkey.ToHexString());
      Assert.Equal("", data.TapScript.ToHexString());
      var key = tapBranch.GetTweakedPrivkey(internalPrivkey);
      Assert.Equal("3a56ec9129732312a78db4b845138a3180c102621d7381ae6e6a5d530f14856a", key.ToHexString());
    }
  }
}
