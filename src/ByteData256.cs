...
{
  /// <summary>
  /// 256bit byte data class.
  /// </summary>
  public class ByteData256 : IEquatable<ByteData256>
  {
    ...
    public ByteData256(string hex) : this(hex, false)
    {
      // do nothing
    }
    ...
    public bool Equals(ByteData256 other)
    {
      if (other is null)
      {
        return false;
    ...
    public override bool Equals(object obj)
    {
      ...
      if ((obj as ByteData256) != null)
      {
        return Equals((ByteData256)obj);
      }
      return false;
    }
    ...
    public static bool operator ==(ByteData256 lhs, ByteData256 rhs)
    {
      if (lhs is null)
      {
        if (rhs is null)
